...
info 'configure nginx installation start.'
    ...
    ./configure --prefix=$INSTALL_DIR_BIN_BIN --pid-path=$INSTALL_FILE_BIN_PID --user=$ENV_USER --group=$ENV_GROUP --with-http_ssl_module --with-http_gzip_static_module  --with-http_stub_status_module --with-pcre --with-zlib
