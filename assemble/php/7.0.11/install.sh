...
./configure --prefix=$INSTALL_DIR_BIN_BIN --with-fpm-user=$ENV_USER --with-fpm-group=$ENV_GROUP --enable-fpm --disable-short-tags --disable-ipv6 --with-zlib --with-pdo-mysql --enable-mbstring --with-openssl --enable-zip --with-mcrypt --with-curl
