...
URL_VAR="URL_BINCODE_NGINX URL_BINCODE_PHP URL_BINCODE_MYSQL URL_BINCODE_BIND"

DIR_VAR="INSTALL_DIR_DATA INSTALL_DIR_BIN INSTALL_DIR_LOG INSTALL_DIR_APP \
LOG_DIR_NGINX LOG_DIR_PHP LOG_DIR_MYSQL LOG_DIR_BIND \
INSTALL_DIR_NGINX INSTALL_DIR_PHP INSTALL_DIR_MYSQL INSTALL_DIR_BIND"

BIN_VAR="ENV_USER ENV_GROUP \
